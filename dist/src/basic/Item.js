...
}_createClass(Item,[{key:"componentWillReceiveProps",value:function componentWillReceiveProps(
...
newChildren.push(_react2.default.createElement(_Icon.Icon,_extends({key:"i1"},iconProps,{__source:{fileName:_jsxFileName,lineNumber:134}})));
newChildren.push(
...
paddingBottom:_reactNative.Platform.OS==="ios"?undefined:12},__source:{fileName:_jsxFileName,lineNumber:136}},


_react2.default.createElement(_Label.Label,_extends({},labelProps,{__source:{fileName:_jsxFileName,lineNumber:148}}),this.renderLabel(label,labelProps))));
...
if(inputProps.value){
_this2.setState({isFocused:true});
}else if(!_this2.state.text.length){
...
_react2.default.createElement(_Label.Label,_extends({},labelProps,{__source:{fileName:_jsxFileName,lineNumber:193}}),this.renderLabel(label,labelProps))));


newChildren.push(
_react2.default.createElement(_Input.Input,_extends({
ref:function ref(c){return _this2._inputRef=c;},
...
flexDirection:"row",
flex:1,
width:_platform2.default.deviceWidth-15},__source:{fileName:_jsxFileName,lineNumber:230}},


_react2.default.createElement(_Icon.Icon,_extends({key:"s1"},iconProps,{__source:{fileName:_jsxFileName,lineNumber:238}})),
_react2.default.createElement(_reactNative.View,{style:{flexDirection:"column"},__source:{fileName:_jsxFileName,lineNumber:239}},
_react2.default.createElement(_Label.Label,_extends({key:"s2"},labelProps,{__source:{fileName:_jsxFileName,lineNumber:240}})),
_react2.default.createElement(_Input.Input,_extends({key:"s3"},inputProps,{style:{width:_platform2.default.deviceWidth-40},__source:{fileName:_jsxFileName,lineNumber:241}})))));
...
{var _this3=this;
return(
_react2.default.createElement(_reactNative.TouchableOpacity,_extends({ref:function ref(c){return _this3._root=c;}},this.prepareRootProps(),{activeOpacity:1,__source:{fileName:_jsxFileName,lineNumber:268}}),
this.renderChildren()));
